                        ...
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    <a href="/learning_support/registerCourse" class="btn btn-primary m-1">수강신청</a>
                                    <a href="/mypage/getCourseScores" class="btn btn-success m-1">성적확인</a>
                                    <a href="/mypage/getCourseTimetable" class="btn btn-warning m-1">시간표조회</a>
                                    <a href="/notice/getNotices" class="btn btn-info m-1">공지사항</a>
                                </div>
                            </div>
                        </div>
                    </div>
