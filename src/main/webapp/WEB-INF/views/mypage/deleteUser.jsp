		...
		<form action="deleteUser" method="post">
			...
			<div class="mb-3">
				<label for="email" class="form-label">이메일</label> <input
					type="email" class="form-control" id="email" name="studentEmail">
			</div>

			<div class="mb-3">
				<label for="major" class="form-label">전공선택</label> <select
			...
			<div class="text-center">
				<a href="javascript:c()" class="btn btn-link-custom">취소하고 싶으면
					클릭!</a>
			</div>
		</form>
	</c:if>
	<c:if test="${msg!=null}">
		<h3 style="green">${msg}</h3>
		<button class="btn btn-custom w-100 mb-3" onclick="exit()">나가기</button>
	</c:if>
